      ...
      <v-container style="max-width: 93% !important">
          ...
          <v-col cols="5">
            <div class="position-relative" style="width: 90%">
              <input
                ...
                name="navSearch"
                id="navSearch"
                class="py-3 px-5 bg-white w-100"
        ...
        <v-row class="mt-6">
          ...
          <v-col cols="5" class="d-flex justify-end">
            <div class="help d-flex align-center justify-content-center">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fas"
            ...
            <div
              class="lang d-flex align-center justify-content-center"
              id="lnguage-btn"
            >
...
export default {
  ...
  data: () => ({
    selectedLang: [
      {
        icon: `
        <svg style="width:20px; margin-bottom: -4px;"
                        xmlns="http://www.w3.org/2000/svg"
                        version="1.1"
                        x="0px"
                        y="0px"
    ...
    langs: [
      {
        icon: `<svg style="width:20px; margin-bottom: -4px;"
                        xmlns="http://www.w3.org/2000/svg"
                        version="1.1"
                        x="0px"
                        y="0px"
